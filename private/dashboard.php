        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm p-3 border-start border-primary border-4">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="mb-0 fw-bold" id="totalBautismos">
            ...
            <div class="col-md-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white py-3 border-0">
                        <h5 class="mb-0 fw-bold text-primary"><i class="bi bi-lightning-charge me-2"></i>Acciones Rápidas
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <?php if ($rolUsuario === 'admin' || $rolUsuario == 'secretario'): ?>
                                <div class="col-6 col-md-4">
                                    <a href="feligres.php" class="btn btn-outline-primary w-100 py-3">
                            ...
                            <?php if ($rolUsuario === 'admin' || $rolUsuario === 'secretario'): ?>
                                <div class="col-6 col-md-4">
                                    <a href="pagos.php" class="btn btn-outline-success w-100 py-3">
                                        <i class="bi bi-cash-stack d-block h4"></i> Estipendios
                                    </a>
                                </div>
                                <?php endif; ?>
            ...
            <div class="card border-0 shadow-sm text-center p-4">
                ...
                <div class="alert alert-light border-0 small">
                    ...
                    if ($rolUsuario === 'parroco') {
                        ...
                        echo "Modo gestión: Puede registrar y editar todos los módulos excepto usuarios.";
                    } else {
                        echo "Modo total: Gestión completa del sistema. ";
                    }
                    ?>
                </div>
