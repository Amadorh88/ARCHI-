...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-02-2026 a las 10:48:59
...
INSERT INTO `bautismo` (`id_bautismo`, `registro`, `id_feligres`, `fecha`, `padrino`, `madrina`, `id_ministro`, `id_parroquia`, `estado`) VALUES
(1, 'B001', 1, '1997-06-15', 'Miguel Torres', 'Laura Díaz', 1, 1, 1),
(2, 'Mtg-145', 4, '2026-01-30', NULL, NULL, 4, 1, 1),
(3, 'BAU-2541', 7, '2026-02-10', 'Justo sima', 'melani costa', 3, 1, 1),
(4, 'BAU-8175', 8, '2007-12-08', 'Duga', 'Isabel', 2, 4, 1),
(5, 'BAU-6887', 9, '2026-02-12', 'Antonio Angono', 'Emilia Andeme', 4, 1, 1);
...
(1, 1, 1, 1, 1, 16, 'Primera comunión'),
(2, 2, 1, 2, 2, NULL, 'Matrimonial'),
(3, 2, 1, 2, NULL, 13, 'Matrimonial'),
(4, 4, 1, 1, NULL, 13, 'Pre-bautismal'),
(5, 7, 1, 3, 3, 16, 'Pre-bautismal'),
(6, 8, 1, 3, 4, 16, 'Pre-bautismal'),
(7, 8, 1, 3, 4, 16, 'Pre-bautismal'),
(8, 9, 1, 3, 1, 24, 'Pre-bautismal'),
(9, 9, 1, 3, 1, 24, 'Pre-bautismal'),
(10, 7, 1, 1, 1, 24, 'Primera comunión'),
(11, 9, 1, 1, 1, 24, 'Primera comunión'),
(12, 9, 1, NULL, 1, 24, 'Confirmación'),
(13, 9, 1, NULL, 1, 24, 'Confirmación'),
(14, 9, 1, 2, 1, 24, 'Matrimonial');
...
(2, 'Ch-52147', 3, '2025-12-29', 3, 3, 1),
(3, 'COM-1802', 9, '2026-02-17', 2, 4, 1);
...
(1, 'CONF001', 2, '2014-06-30', 2, 2, 1),
(2, 'Mpp-145', 4, '2026-01-06', 3, 3, 1),
(3, 'CON-7921', 9, '2026-02-17', 2, 4, 1);
...
(9, 'FELIGRES', 'JOSE ONDO', 'ANA ADA', '2026-02-03', 'Malabo'),
(10, 'PRUEBA', 'PADRE PRUEBA', 'MADRES PRUEBA', '2026-02-09', 'Malabo');
...
--
ALTER TABLE `catequesis`
  MODIFY `id_catequesis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `comunion`
  MODIFY `id_comunion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `confirmacion`
--
ALTER TABLE `confirmacion`
  MODIFY `id_confirmacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `feligres`
  MODIFY `id_feligres` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `matrimonio`
--
ALTER TABLE `matrimonio`
  MODIFY `id_matrimonio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `matrimonio_feligres`
--
ALTER TABLE `matrimonio_feligres`
  MODIFY `id_matrimonio_feligres` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
