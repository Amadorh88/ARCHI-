...
// ... (El código de consulta PHP se mantiene igual que en la respuesta anterior) ...

$query = "SELECT * FROM catequista WHERE 1=1"; // Tabla ajustada
$params = [];

if (!empty($busqueda)) {
    // Búsqueda en nombre, telefono, y especialidad
...
$query .= " ORDER BY nombre ASC LIMIT 50"; // Ordenar por 'nombre'
...
<div style="margin-bottom: 2rem; display: flex; flex-wrap: wrap; gap: 1rem; align-items: center; justify-content: space-between;">
    ...
    <div style="display: flex; gap: 0.5rem;">
        <button  style="padding: 0.5rem 1rem; border: none; border-radius: 4px; cursor: pointer; background-color: #27ae60; color: white; font-weight: bold;"
 
        class="btn-action btn-create tooltip" 
        onclick="ModalSystem.open('catequista', 'crear')">
    <i class="fas fa-plus"></i> Agregar
    <span class="tooltiptext">Agregar catequista</span>
        </button>
