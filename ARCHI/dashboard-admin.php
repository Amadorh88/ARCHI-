                ...
                <div class="header">
                    ...
                    <div class="user-info">
                        ...
                        <span class="role-badge <?php echo htmlspecialchars($Rolusuario); ?>-badge tooltip">
                            ...
                            <?php echo htmlspecialchars(getRoleDisplayName($Rolusuario)); ?>
                            <span class="tooltiptext">Rol:
                                <?php echo htmlspecialchars(getRoleDisplayName($Rolusuario)); ?> - Privilegios
                                completos</span>
                        </span>
